 ...
 */
uint32_t cyg_crc32_accumulate(uint32_t crc32val, unsigned char *s,
		int len) {
	int i;
 ...
 * algorithm.
 */
uint32_t cyg_ether_crc32_accumulate(uint32_t crc32val, unsigned char *s,
		int len) {
	int i;
 ...
 */
static int32_t cyg_crc32_in_table(uint32_t value) {
	int i;
